...
With the addition of MCP, we have brought these features to the communication between Agents and external tools, making EAIGW even more versatile for enterprise-scale AI deployments. For a deeper look at the collaborative story and technical vision, see the [Bloomberg partnership announcement](https://tetrate.io/blog/tetrate-bloomberg-collaborating-on-envoy-ai-gateway), their [official release coverage](https://www.bloomberg.com/company/press/tetrate-and-bloomberg-release-open-source-envoy-ai-gateway-built-on-cncfs-envoy-gateway-project/), and previous [project announcements](01-release-announcement).
...
We thank [Tetrate](https://tetrate.io/) for contributing the implementation of the MCP protocol, and look forward to continue enhancing Envoy AI Gateway together with the community and bring more use cases and features to the project.
