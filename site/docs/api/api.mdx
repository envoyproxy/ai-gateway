...
<ApiField
  ...
  required="false"
  description="Env specifies environment variables to be added to the external processor container.<br />These variables are merged with any global environment variables configured in the<br />AI Gateway controller. If there are conflicting variable names, the values defined<br />here take precedence over global values.<br />Common use cases include:<br />- OTEL tracing configuration (e.g., OTEL_EXPORTER_OTLP_HEADERS, OTEL_EXPORTER_OTLP_ENDPOINT)"
/><ApiField
  name="resources"
  type="[ResourceRequirements](https://kubernetes.io/docs/reference/generated/kubernetes-api/v1.29/#resourcerequirements-v1-core)"
  required="false"
