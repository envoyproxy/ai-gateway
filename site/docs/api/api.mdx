...
/><ApiField
  ...
  required="false"
  description="ExternalProcessor is the configuration for the external process filter.<br />This is optional, and if not set, the default values of Deployment spec will be used."
/>
