...
/><ApiField
  ...
  type="enum"
  required="false"
  description="APISchemaAWSOpenAI is the schema for OpenAI models hosted on AWS Bedrock.<br />Uses the AWS Bedrock InvokeModel API with OpenAI format for requests and responses.<br />https://aws.amazon.com/bedrock/<br />"
/>
#### AWSCredentialsFile
