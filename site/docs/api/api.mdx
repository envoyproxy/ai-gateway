...
/><ApiField
  name="GCPAnthropicToNative"
  type="enum"
  required="false"
  description="APISchemaGCPAnthropicToNative represents GCP Anthropic with native Anthropic output format.<br />Used for Claude models hosted on Google Cloud Vertex AI that should return native Anthropic format.<br />"
/><ApiField
  name="Anthropic"
  type="enum"
  required="false"
  description="APISchemaAnthropic is the native Anthropic API schema.<br />https://docs.anthropic.com/en/api/messages<br />"
/>
#### AWSCredentialsFile
