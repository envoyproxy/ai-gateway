...
<ApiField
  ...
  required="true"
  description="JWTSource defines the JWT scopes required for this rule to match."
/>
...
<ApiField
  ...
  required="false"
  description="Rules defines a list of authorization rules.<br />Requests that match any rule and satisfy the rule's conditions will be allowed.<br />Requests that do not match any rule or fail to satisfy the matched rule's conditions will be denied.<br />If no rules are defined, all requests will be denied."
/>
...
<ApiField
  ...
  type="string"
  required="true"
  description="BackendName is the name of the backend this tool belongs to."
/><ApiField
  name="toolName"
  type="string"
  required="true"
