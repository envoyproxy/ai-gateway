...
/><ApiField
  ...
  type="string array"
  required="false"
  description="Sensitive headers will be removed while sending request to upstream.<br />These headers will be added back to the request if request fails upstream"
/><ApiField
  name="apiKey"
