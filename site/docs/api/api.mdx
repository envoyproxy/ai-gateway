...
- [AzureClientSecretCredential](#azureclientsecretcredential)
...
/><ApiField
  ...
  type="[AzureClientSecretCredential](#azureclientsecretcredential)"
  required="false"
  description="ClientSecretCredential specifies the client secret used to obtain azure access token."
/>
