...
/><ApiField
  ...
  required="false"
  description="BackendSecurityPolicyRef is the name of the BackendSecurityPolicy resources this backend<br />is being attached to.<br />Deprecated: BackendSecurityPolicy should use targetRefs to target AIServiceBackend instead.<br />This field will be dropped in Envoy AI Gateway v0.3.0."
/>
