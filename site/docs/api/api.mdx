...
<ApiField
  name="azureClientCredentials"
  type="[AzureClientCredentials](#azureclientcredentials)"
  required="false"
  description="ClientCredentials specifies the client id/secret and tenant id used to obtain azure access token."
/>
