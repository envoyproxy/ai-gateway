...
- [AzureApplicationIdentity](#azureapplicationidentity)
...
<ApiField
  ...
  type="[AzureApplicationIdentity](#azureapplicationidentity)"
  required="false"
  description="ApplicationIdentity specifies the client id/secret and tenant id used to obtain azure access token."
/>
