...
/><ApiField
  ...
  required="false"
  description="BackendSecurityPolicyRef is the name of the BackendSecurityPolicy resources this backend<br />is being attached to.<br />Deprecated: BackendSecurityPolicy should use targetRefs to target AIServiceBackend instead.<br />This field will be dropped after Envoy AI Gateway v0.3 release."
/>
...
<ApiField
  ...
  required="false"
  description="TargetRefs are the names of the AIServiceBackend resources this BackendSecurityPolicy is being attached to.<br />This follows the Gateway API policy attachment pattern where policies target their resources directly."
/><ApiField
  name="type"
