...
This release represents several months of community collaboration and introduces important features that enhance the gateway's production readiness and enterprise capabilities.
...
We're already working on exciting features for upcoming v0.2.x patch releases:
