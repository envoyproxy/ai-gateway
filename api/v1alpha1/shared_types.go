...
type VersionedAPISchema struct {
	...
	//
	// This is especially useful when routing to a backend that has an OpenAI- or Anthropic-compatible API but
	// has a different prefix. For example, Gemini OpenAI compatible API (https://ai.google.dev/gemini-api/docs/openai)
	// uses "/v1beta/openai" prefix. Another example is that Cohere AI (https://docs.cohere.com/v2/docs/compatibility-api)
	...
	//
	// This field is only honored for "OpenAI" and "Anthropic" schemas. For "AWSAnthropic" and "GCPAnthropic"
	// the request path is dictated by the cloud provider's API and this field is ignored.
	//
	// See https://aigateway.envoyproxy.io/docs/capabilities/llm-integrations/supported-providers for details.
	// +optional
