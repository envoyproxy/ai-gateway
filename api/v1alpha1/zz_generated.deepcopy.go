...
// DeepCopyObject is an autogenerated deepcopy function, copying the receiver, creating a new runtime.Object.
func (in *LLMProviderPolicy) DeepCopyObject() runtime.Object {
	if c := in.DeepCopy(); c != nil {
		return c
	}
	return nil
...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *LLMProviderPolicyList) DeepCopyInto(out *LLMProviderPolicyList) {
	*out = *in
	out.TypeMeta = in.TypeMeta
	in.ListMeta.DeepCopyInto(&out.ListMeta)
	if in.Items != nil {
		in, out := &in.Items, &out.Items
		*out = make([]LLMProviderPolicy, len(*in))
		for i := range *in {
			(*in)[i].DeepCopyInto(&(*out)[i])
		}
	}
...
// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new LLMProviderPolicyList.
func (in *LLMProviderPolicyList) DeepCopy() *LLMProviderPolicyList {
	if in == nil {
		return nil
	}
	out := new(LLMProviderPolicyList)
	in.DeepCopyInto(out)
	return out
}

// DeepCopyObject is an autogenerated deepcopy function, copying the receiver, creating a new runtime.Object.
func (in *LLMProviderPolicyList) DeepCopyObject() runtime.Object {
	if c := in.DeepCopy(); c != nil {
		return c
	}
	return nil
...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *LLMProviderPolicySpec) DeepCopyInto(out *LLMProviderPolicySpec) {
	*out = *in
	if in.BackendRefs != nil {
		in, out := &in.BackendRefs, &out.BackendRefs
		*out = make([]apiv1alpha1.BackendRef, len(*in))
...
// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new LLMProviderPolicySpec.
func (in *LLMProviderPolicySpec) DeepCopy() *LLMProviderPolicySpec {
	if in == nil {
		return nil
	}
	out := new(LLMProviderPolicySpec)
	in.DeepCopyInto(out)
	return out
}
