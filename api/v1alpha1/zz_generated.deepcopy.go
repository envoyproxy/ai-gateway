...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *LLMRouteMatch) DeepCopyInto(out *LLMRouteMatch) {
	*out = *in
	if in.Headers != nil {
...
// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new LLMRouteMatch.
func (in *LLMRouteMatch) DeepCopy() *LLMRouteMatch {
	if in == nil {
		return nil
	}
	out := new(LLMRouteMatch)
	in.DeepCopyInto(out)
	return out
}
