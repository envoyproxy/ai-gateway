...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *AzureClientSecretCredential) DeepCopyInto(out *AzureClientSecretCredential) {
	*out = *in
...
// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new AzureClientSecretCredential.
func (in *AzureClientSecretCredential) DeepCopy() *AzureClientSecretCredential {
	if in == nil {
		return nil
	}
	out := new(AzureClientSecretCredential)
	in.DeepCopyInto(out)
	return out
}
...
func (in *BackendSecurityPolicyAzureCredentials) DeepCopyInto(out *BackendSecurityPolicyAzureCredentials) {
	*out = *in
	if in.ClientSecretCredential != nil {
		in, out := &in.ClientSecretCredential, &out.ClientSecretCredential
		*out = new(AzureClientSecretCredential)
		(*in).DeepCopyInto(*out)
	}
}
