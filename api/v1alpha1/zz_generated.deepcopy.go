...
func (in *AIServiceBackendSpec) DeepCopyInto(out *AIServiceBackendSpec) {
	*out = *in
	...
	if in.ResponseBodyMutation != nil {
		in, out := &in.ResponseBodyMutation, &out.ResponseBodyMutation
		*out = new(HTTPResponseBodyMutation)
		(*in).DeepCopyInto(*out)
	}
}
...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *HTTPResponseBodyMutation) DeepCopyInto(out *HTTPResponseBodyMutation) {
	*out = *in
	if in.Remove != nil {
		in, out := &in.Remove, &out.Remove
		*out = make([]string, len(*in))
...
// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new HTTPResponseBodyMutation.
func (in *HTTPResponseBodyMutation) DeepCopy() *HTTPResponseBodyMutation {
	if in == nil {
		return nil
	}
	out := new(HTTPResponseBodyMutation)
