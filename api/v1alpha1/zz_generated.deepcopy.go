...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *AzureApplicationIdentity) DeepCopyInto(out *AzureApplicationIdentity) {
	*out = *in
...
// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new AzureApplicationIdentity.
func (in *AzureApplicationIdentity) DeepCopy() *AzureApplicationIdentity {
	if in == nil {
		return nil
	}
	out := new(AzureApplicationIdentity)
	in.DeepCopyInto(out)
	return out
}
...
func (in *BackendSecurityPolicyAzureCredentials) DeepCopyInto(out *BackendSecurityPolicyAzureCredentials) {
	*out = *in
	if in.ApplicationIdentity != nil {
		in, out := &in.ApplicationIdentity, &out.ApplicationIdentity
		*out = new(AzureApplicationIdentity)
		(*in).DeepCopyInto(*out)
	}
}
