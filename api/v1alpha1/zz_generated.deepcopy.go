...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *OpenAISchemaConfig) DeepCopyInto(out *OpenAISchemaConfig) {
	*out = *in
}

// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new OpenAISchemaConfig.
func (in *OpenAISchemaConfig) DeepCopy() *OpenAISchemaConfig {
	if in == nil {
		return nil
	}
	out := new(OpenAISchemaConfig)
	in.DeepCopyInto(out)
	return out
}
