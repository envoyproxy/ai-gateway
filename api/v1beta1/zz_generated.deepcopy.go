...
func (in *AIGatewayRouteSpec) DeepCopyInto(out *AIGatewayRouteSpec) {
	*out = *in
	...
	if in.RateLimitsFromHeaders != nil {
		in, out := &in.RateLimitsFromHeaders, &out.RateLimitsFromHeaders
		*out = make([]RateLimitFromHeader, len(*in))
		copy(*out, *in)
	}
}
...
func (in *GatewayConfigSpec) DeepCopyInto(out *GatewayConfigSpec) {
	*out = *in
	...
	if in.GlobalRateLimitsFromHeaders != nil {
		in, out := &in.GlobalRateLimitsFromHeaders, &out.GlobalRateLimitsFromHeaders
		*out = make([]RateLimitFromHeader, len(*in))
		copy(*out, *in)
	}
}
...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *RateLimitFromHeader) DeepCopyInto(out *RateLimitFromHeader) {
	*out = *in
}

// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new RateLimitFromHeader.
func (in *RateLimitFromHeader) DeepCopy() *RateLimitFromHeader {
	if in == nil {
		return nil
	}
	out := new(RateLimitFromHeader)
	in.DeepCopyInto(out)
	return out
}
