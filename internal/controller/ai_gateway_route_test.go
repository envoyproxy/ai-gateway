	...
	}{
		{
			...
			exp: &filterapi.Config{
				...
				LLMRequestCosts: []filterapi.LLMRequestCost{
					{Type: aigv1a1.LLMRequestCostTypeOutputToken, MetadataKey: "output-token"},
					{Type: aigv1a1.LLMRequestCostTypeInputToken, MetadataKey: "input-token"},
					{Type: aigv1a1.LLMRequestCostTypeTotalToken, MetadataKey: "total-token"},
					{Type: aigv1a1.LLMRequestCostTypeCEL, MetadataKey: "cel-token", CEL: "model == 'cool_model' ?  input_tokens * output_tokens : total_tokens"},
				},
			},
		},
	} {
