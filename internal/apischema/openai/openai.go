...
type ChatCompletionResponseChoiceMessage struct {
	...
	// ResponseVendorFields is used to hold any non-standard fields from the backend,
	// like "reasoningContent" from AWS Bedrock.
	*ResponseVendorFields `json:",inline,omitempty"`
}
...
// ResponseVendorFields contains extra vendor-specific fields to add to the openai response.
type ResponseVendorFields struct {
