...
type ChatCompletionResponseChoiceMessage struct {
	...
	// AnthropicResponseVendorFields is used to hold any non-standard fields from the backend,
	// like "reasoningContent" from AWS Bedrock.
	*AnthropicResponseVendorFields `json:",inline,omitempty"`
}
...
// AnthropicResponseVendorFields contains extra vendor-specific fields to add to the openai response.
type AnthropicResponseVendorFields struct {
