...
const (
	...
	ChatCompletionChoicesFinishReasonContextWindowExceeded ChatCompletionChoicesFinishReason = "context_window_exceeded"
	ChatCompletionChoicesFinishReasonPauseTurn             ChatCompletionChoicesFinishReason = "pause_turn"
)
