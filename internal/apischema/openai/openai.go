...
type ImageGenerationRequest struct {
	...
	N int `json:"n,omitempty"`
	// The quality of the image that will be generated. hd or standard. DALL-E 3 only.
...
type ImageGenerationResponseData struct {
	B64JSON       string `json:"b64_json,omitempty"`       //nolint:tagliatelle //follow openai api
	URL           string `json:"url,omitempty"`            //nolint:tagliatelle //follow openai api
	RevisedPrompt string `json:"revised_prompt,omitempty"` //nolint:tagliatelle //follow openai api
}
