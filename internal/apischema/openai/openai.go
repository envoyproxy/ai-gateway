...
func (r ResponseApplyPatchToolCallOperationUnion) MarshalJSON() ([]byte, error) {
	...
	default:
		return nil, errors.New("no tool call operation to marshal")
	}
}
...
func (r ResponseStreamEventUnion) MarshalJSON() ([]byte, error) { // nolint:gocritic
	...
	default:
		return nil, errors.New("no response stream event to marshal in ResponseStreamEventUnion")
	}
}
...
func (r *ResponseStreamEventUnion) UnmarshalJSON(data []byte) error {
	...
	default:
		return fmt.Errorf("unknown type field value '%s' for ResponseStreamEventUnion", typ.String())
	}
	return nil
}
...
func (r ResponseCodeInterpreterToolCallOutputUnion) MarshalJSON() ([]byte, error) {
	...
	default:
		return nil, errors.New("no output to marshal in ResponseCodeInterpreterToolCallOutputUnion")
	}
}
...
func (r *ResponseCodeInterpreterToolCallOutputUnion) UnmarshalJSON(data []byte) error {
	...
	case "image":
		...
		return nil
	default:
		return fmt.Errorf("unknown type for ResponseCodeInterpreterToolCallOutputUnion: %s", typ.String())
	}
}
...
func (r ResponseContentPartAddedEventPartUnion) MarshalJSON() ([]byte, error) {
	...
	default:
		return nil, errors.New("no part to marshal in ResponseContentPartAddedEventPartUnion")
	}
}
...
func (r *ResponseContentPartAddedEventPartUnion) UnmarshalJSON(data []byte) error {
	...
	case "reasoning_text":
		...
		return nil
	default:
		return fmt.Errorf("unknown type for ResponseContentPartAddedEventPartUnion: %s", typ.String())
	}
}
...
func (r ResponseContentPartDoneEventPartUnion) MarshalJSON() ([]byte, error) {
	...
	default:
		return nil, errors.New("no part to marshal in ResponseContentPartDoneEventPartUnion")
	}
}
...
func (r *ResponseContentPartDoneEventPartUnion) UnmarshalJSON(data []byte) error {
	...
	case "reasoning_text":
		...
		return nil
	default:
		return fmt.Errorf("unknown type for ResponseContentPartDoneEventPartUnion: %s", typ.String())
	}
}
...
type ResponseTextDeltaEvent struct {
	...
	Logprobs []ResponseTextDeltaEventLogprob `json:"logprobs"`
...
type ResponseTextDoneEvent struct {
	...
	ItemID string `json:"item_id"`
	// The log probabilities of the tokens in the delta.
	Logprobs []ResponseTextDoneEventLogprob `json:"logprobs"`
