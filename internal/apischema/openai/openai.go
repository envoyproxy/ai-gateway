...
// AnthropicMessageFields contains Anthropic model-specific fields that can be added to messages.
type AnthropicMessageFields struct {
...
type ChatCompletionUserMessageParam struct {
	...
	*AnthropicMessageFields `json:",inline,omitempty"`
}
