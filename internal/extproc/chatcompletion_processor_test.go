...
func Test_chatCompletionProcessorUpstreamFilter_SensitiveHeaders_RemoveAndRestore(t *testing.T) {
	...
	t.Run("remove sensitive headers", func(t *testing.T) {
		p := &chatCompletionProcessorUpstreamFilter{
