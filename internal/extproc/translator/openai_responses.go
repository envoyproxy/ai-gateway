...
func (o *openAIToOpenAITranslatorV1Responses) RequestBody(original []byte, req *openai.ResponseRequest, forceBodyMutation bool) (
	...
	if o.modelNameOverride != "" {
		...
		newBody, err = sjson.SetBytes(original, "model", modelName)
		if err != nil {
			return nil, nil, fmt.Errorf("failed to set model: %w", err)
		}
	}

	// Store the request model and stream flag for later use
...
func (o *openAIToOpenAITranslatorV1Responses) ResponseBody(headers map[string]string, body io.Reader, endOfStream bool, span tracing.ResponsesSpan) (
	...
	return o.handleNonStreamingResponse(body)
}

// handleStreamingResponse handles streaming responses from the Responses API.
func (o *openAIToOpenAITranslatorV1Responses) handleStreamingResponse(body io.Reader, endOfStream bool) (
	headerMutation *extprocv3.HeaderMutation, bodyMutation *extprocv3.BodyMutation, tokenUsage LLMTokenUsage, responseModel internalapi.ResponseModel, err error,
) {
...
func (o *openAIToOpenAITranslatorV1Responses) handleNonStreamingResponse(body io.Reader) (
	headerMutation *extprocv3.HeaderMutation, bodyMutation *extprocv3.BodyMutation, tokenUsage LLMTokenUsage, responseModel internalapi.ResponseModel, err error,
) {
...
func (o *openAIToOpenAITranslatorV1Responses) extractUsageFromBufferEvent() (tokenUsage LLMTokenUsage) {
