...
func (m *mockAudioSpeechTranslator) RequestBody(_ []byte, body *openai.AudioSpeechRequest, _ bool) (*extprocv3.HeaderMutation, *extprocv3.BodyMutation, error) {
...
func (m *mockAudioSpeechTranslator) ResponseHeaders(headers map[string]string) (*extprocv3.HeaderMutation, error) {
	if m.expHeaders != nil {
...
func (m *mockAudioSpeechTranslator) ResponseBody(_ map[string]string, body io.Reader, _ bool) (*extprocv3.HeaderMutation, *extprocv3.BodyMutation, translator.LLMTokenUsage, internalapi.ResponseModel, error) {
...
func (m *mockAudioSpeechTranslator) ResponseError(_ map[string]string, body io.Reader) (*extprocv3.HeaderMutation, *extprocv3.BodyMutation, error) {
