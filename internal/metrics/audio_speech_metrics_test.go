...
func TestNewAudioSpeechFactory(t *testing.T) {
	...
	assert.NotNil(t, am)
	assert.Equal(t, genaiOperationAudioSpeech, am.operation)
}

func TestAudioSpeech_StartRequest(t *testing.T) {
...
func TestAudioSpeech_RecordTokenUsage(t *testing.T) {
	...
	var (
		...
		attrs = []attribute.KeyValue{
			attribute.Key(genaiAttributeOperationName).String(genaiOperationAudioSpeech),
...
func TestAudioSpeech_RecordRequestCompletion(t *testing.T) {
	synctest.Test(t, testAudioSpeechRecordRequestCompletion)
}

func testAudioSpeechRecordRequestCompletion(t *testing.T) {
	t.Helper()
