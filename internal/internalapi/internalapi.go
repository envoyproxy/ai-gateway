...
const (
	...
	// AIGatewayStickyRouteOwnerLabel stores the owning AIGatewayRoute name on
	// generated sticky per-backend HTTPRoutes.
	AIGatewayStickyRouteOwnerLabel = "aigateway.envoyproxy.io/owner"
	// AIGatewayStickyRouteOwnerNamespaceLabel stores the owning AIGatewayRoute
	// namespace on generated sticky per-backend HTTPRoutes.
	AIGatewayStickyRouteOwnerNamespaceLabel = "aigateway.envoyproxy.io/owner-namespace"
	// AIGatewayStickyRouteBackendLabel stores the backend reference name on
	// generated sticky per-backend HTTPRoutes.
	AIGatewayStickyRouteBackendLabel = "aigateway.envoyproxy.io/backend"
	// AIGatewayStickyRouteTypeLabel marks generated route type on sticky
	// per-backend HTTPRoutes.
	AIGatewayStickyRouteTypeLabel = "aigateway.envoyproxy.io/route-type"
	// AIGatewayStickyRouteTypePerBackend is the route-type label value used for
	// generated sticky per-backend HTTPRoutes.
	AIGatewayStickyRouteTypePerBackend = "sticky-route"
)
