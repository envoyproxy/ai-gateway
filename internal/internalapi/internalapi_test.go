...
func TestConstants(t *testing.T) {
	...
	require.Equal(t, "per_route_rule_route_name", InternalMetadataRouteNameKey)
	require.Equal(t, "x-gateway-destination-endpoint", EndpointPickerHeaderKey)
	require.Equal(t, "xds.route_metadata.filter_metadata['aigateway.envoy.io']['per_route_rule_route_name']", XDSRouteMetadataRouteNamePath)
}
