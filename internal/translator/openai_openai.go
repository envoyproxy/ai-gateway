...
func (o *openAIToOpenAITranslatorV1ChatCompletion) ResponseBody(_ map[string]string, body io.Reader, _ bool, span tracingapi.ChatCompletionSpan) (
	...
	if resp.Usage.PromptTokensDetails != nil {
		...
		tokenUsage.SetCacheCreationInputTokens(uint32(resp.Usage.PromptTokensDetails.CacheWriteTokens)) //nolint:gosec
	}
	...
	for {
		...
		if usage := event.Usage; usage != nil {
			...
			if usage.PromptTokensDetails != nil {
				...
				tokenUsage.SetCacheCreationInputTokens(uint32(usage.PromptTokensDetails.CacheWriteTokens)) //nolint:gosec
			}
