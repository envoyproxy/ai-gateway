...
type Backend struct {
	...
	// the HTTPRoute weighted clusters generated by the controller).
	Weight *int32 `json:"weight,omitempty"`
	// Priority is the failover priority of this backend within its route rule (mirrors
	// AIGatewayRouteRuleBackendRef.Priority; default 0, lower = higher priority). Populated
	// by the controller for quota-aware routing; not used by Envoy Gateway's own endpoint
	// priorities (that path uses the controller's priority annotation).
